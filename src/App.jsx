...
function App() {
  ...
  return (
    <Fragment>
      ...
      {/* Main content */}
      <main>
        <div className="flex text-white h-[142px] md:h-[152px] bg-[#643DFF] font-sans">
          <div className="absolute top-0 left-0 w-full h-full p-4 md:grid md:grid-cols-[minmax(0px,_20%)_minmax(0px,_80%)] md:gap-6">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex justify-between items-center py-2">
                <p className="text-lg md:text-base">Data Gempa</p>
                <div className="flex items-center">
                  ...
                  <a className="flex md:hidden rounded-full p-1 ml-5 active:bg-gray-200">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
              ...
              {/* Pagination Section */}
              <div className="flex justify-between items-center text-black px-3 md:px-0">
                <p className="flex items-center">
                  Show
                  <span className="text-xs font-medium rounded-lg p-2 mx-2 border">
                    10
                  </span>{" "}
                  from 15
                </p>
        ...
        {show ? (
          <>
            <div className="fixed p-6 top-0 right-0 z-10 w-[100%] md:w-1/4 h-full bg-white text-black duration-500">
              <div className="">
          ...
          <>
            <div className="fixed invisible top-0 right-[-400px] md:right-[-486px] z-10 w-[90%] md:w-1/4 h-full bg-white text-black duration-500">
              <div className="">
                <div className="flex items-center justify-between w-full">
                  <p className="text-xl font-semibold">Detail</p>
                  <span
